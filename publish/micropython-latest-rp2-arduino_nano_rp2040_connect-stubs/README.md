...
Included stubs:
* StubSource.MERGED from `stubs/micropython-latest-rp2-ARDUINO_NANO_RP2040_CONNECT-merged`
* StubSource.FROZEN from `stubs/micropython-latest-frozen/rp2/ARDUINO_NANO_RP2040_CONNECT`
* StubSource.CORE from `stubs/cpython_core-pycopy`
