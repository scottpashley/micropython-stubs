...
Included stubs:
* StubSource.MERGED from `stubs/micropython-latest-rp2-PICO-merged`
* StubSource.FROZEN from `stubs/micropython-latest-frozen/rp2/PICO`
* StubSource.CORE from `stubs/micropython_core`


origin | Family | Port | Board | Version
-------|--------|------|-------|--------
Firmware | micropython | rp2 | Raspberry Pi Pico with RP2040 | v1.19.1 
