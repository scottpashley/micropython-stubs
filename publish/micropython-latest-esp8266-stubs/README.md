...
Included stubs:
* StubSource.MERGED from `stubs/micropython-latest-esp8266-merged`
* StubSource.FROZEN from `stubs/micropython-latest-frozen/esp8266/GENERIC`
...
Core | micropython | esp8266 | - | latest 
