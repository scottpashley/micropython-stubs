...
Included stubs:
* StubSource.MERGED from `stubs/micropython-latest-stm32-merged`
* StubSource.FROZEN from `stubs/micropython-latest-frozen/stm32/GENERIC`
